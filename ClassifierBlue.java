...
@Autonomous(name = "Blue Auto Pathing Classifier", group = "Pedro Pathing")
public class ClassifierBlue extends OpMode {
    ...
    public static final Pose START_POSE = new Pose(21, 124, Math.toRadians(37));
    public static final Pose SHOOT_POSE = new Pose(25, 120, Math.toRadians(-37));
    // New shooting pose for subsequent shots

    // Staging poses for collection
    public static final Pose COLLECT_POSE1 = new Pose(45, 35, Math.toRadians(0));
    public static final Pose COLLECT_POSE2 = new Pose(45, 60, Math.toRadians(0));
